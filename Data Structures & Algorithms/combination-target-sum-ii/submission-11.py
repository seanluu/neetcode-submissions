class Solution:
    def combinationSum2(self, candidates: List[int], target: int) -> List[List[int]]:
        ...
        candidates.sort()  # enables dedup (equal values become adjacent) and early break (later elements only get bigger)
        # same idea as 3Sum: sort so dupes are adjacent -> skip -> avoid duplicate combos
