class Solution:
    def dailyTemperatures(self, temperatures: List[int]) -> List[int]:
        ...
        for i, t in enumerate(temperatures):
            ...
            # comparing the curr temperature to the latest day that we pushed to the stack so that could be like 2 days out or 3 days out depending on when we saw an increase
